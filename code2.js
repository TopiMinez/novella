...
gdjs.Load1LuntikCode.asyncCallback14047372 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Load1LuntikCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Guide1Luntik", false);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Load1LuntikCode.asyncCallback14047372(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Load1LuntikCode.asyncCallback14047132 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Load1LuntikCode.localVariables);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.Load1LuntikCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Load1LuntikCode.asyncCallback14047132(runtimeScene, asyncObjectsList)));
}
}
